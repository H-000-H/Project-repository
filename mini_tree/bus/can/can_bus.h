 ...
 */
mt_err_t can_bus_host_init(struct device* pdev, const struct hal_can_bus_config* cfg) MINI_WARN_UNUSED_RESULT;
/**
 * @brief CAN host 反初始化 (ref_count > 0 时返回 BUSY)
 * @param[in] pdev controller device (host)
 * @return 成功返回 MINI_OK, BUSY 返回 MINI_ERR_BUSY, 失败返回 MINI_ERR_*
 */
mt_err_t can_bus_host_deinit(struct device* pdev) MINI_WARN_UNUSED_RESULT;
/* -------------------------------------------------------------------------- */
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_*
 */
mt_err_t can_bus_client_register(struct device* pdev, struct can_bus_client** out) MINI_WARN_UNUSED_RESULT;
/**
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_*
 */
mt_err_t can_bus_open(struct device* pdev) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 关闭 CAN client 硬件 (幂等)
 * @param[in] pdev client device
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_*
 */
mt_err_t can_bus_close(struct device* pdev) MINI_WARN_UNUSED_RESULT;
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_*
 */
mt_err_t can_bus_transmit(struct device* pdev, const struct can_frame* frame, uint32_t timeout_ms) MINI_WARN_UNUSED_RESULT;
/**
 ...
 * @param[in] timeout_ms 超时 (毫秒)
 * @return 成功返回 MINI_OK, 超时返回 MINI_ERR_TIMEOUT, 失败返回 MINI_ERR_*
 */
mt_err_t can_bus_receive(struct device* pdev, struct can_frame* frame, uint32_t fifo, uint32_t timeout_ms) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 配置 CAN 过滤器
 * @param[in] pdev client device
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_*
 */
mt_err_t can_bus_filter_config(struct device* pdev, const struct hal_can_filter_config* filter) MINI_WARN_UNUSED_RESULT;
 ...
 */
mt_err_t can_bus_get_state(struct device* pdev, uint32_t* out_state) MINI_WARN_UNUSED_RESULT;
/* -------------------------------------------------------------------------- */
