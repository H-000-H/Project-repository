 ...
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_device_init(hal_dac_device* pdev, hal_dac_host_config* host_cfg, hal_dac_platform_unique_config* unique_cfg);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_close(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_init(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_start(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_dma_pause(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_base_pause(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_pause(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_resume(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_set_value(hal_dac_device* pdev, uint32_t value);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_get_value(hal_dac_device* pdev, uint32_t* value);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_get_dma_progress(hal_dac_device* pdev, uint32_t* remaining);
 ...
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_write_dma_buffer(hal_dac_device* pdev, const uint16_t* data, uint32_t len);
 ...
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_stop_dma(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_base_stop(hal_dac_device* pdev);
 ...
 * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_dac_force_stop(hal_dac_device* pdev);
