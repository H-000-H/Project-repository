 ...
 */
mt_err_t hal_iwdg_init(struct hal_iwdg_dev* pdev, const struct hal_iwdg_config* cfg) MINI_WARN_UNUSED_RESULT;
 ...
 * @return MINI_OK 或 MINI_ERR_INVAL
 */
mt_err_t hal_iwdg_start(struct hal_iwdg_dev* pdev) MINI_WARN_UNUSED_RESULT;
 ...
 */
mt_err_t hal_iwdg_feed(struct hal_iwdg_dev* pdev) MINI_WARN_UNUSED_RESULT;
 ...
 * @return MINI_OK 或 MINI_ERR_INVAL
 */
mt_err_t hal_iwdg_set_timeout_ms(struct hal_iwdg_dev* pdev, uint32_t timeout_ms) MINI_WARN_UNUSED_RESULT;
 ...
 * @return MINI_OK 或 MINI_ERR_INVAL
 */
mt_err_t hal_iwdg_set_long_timeout(struct hal_iwdg_dev* pdev) MINI_WARN_UNUSED_RESULT;
 ...
 * @return MINI_OK 或 MINI_ERR_INVAL
 */
mt_err_t hal_iwdg_restore_timeout(struct hal_iwdg_dev* pdev) MINI_WARN_UNUSED_RESULT;
