 ...
 */
mt_err_t hal_wwdg_init(struct hal_wwdg_dev* pdev, const struct hal_wwdg_config* cfg) MINI_WARN_UNUSED_RESULT;
 ...
 * @return MINI_OK 或 MINI_ERR_INVAL
 */
mt_err_t hal_wwdg_start(struct hal_wwdg_dev* pdev) MINI_WARN_UNUSED_RESULT;
 ...
 */
mt_err_t hal_wwdg_feed(struct hal_wwdg_dev* pdev) MINI_WARN_UNUSED_RESULT;
