 ...
 */
mt_err_t hal_rtc_init(struct hal_rtc_dev* pdev, const struct hal_rtc_config* cfg) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 反初始化 RTC 软件对象
 * @param[in] pdev RTC 设备对象指针
 * @return 成功返回 MINI_OK, pdev 为空返回 MINI_ERR_INVAL
 */
mt_err_t hal_rtc_deinit(struct hal_rtc_dev* pdev) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 打开 RTC (引用计数 +1, 首次触发硬件初始化)
 * @param[in] pdev RTC 设备对象指针
 * @return 成功返回 MINI_OK, pdev 为空返回 MINI_ERR_INVAL
 */
mt_err_t hal_rtc_open(struct hal_rtc_dev* pdev) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 关闭 RTC (引用计数 -1)
 * @param[in] pdev RTC 设备对象指针
 ...
 * @return 成功返回 MINI_OK, pdev 为空返回 MINI_ERR_INVAL
 */
mt_err_t hal_rtc_close(struct hal_rtc_dev* pdev) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 设置 RTC 日历时间
 * @param[in] pdev RTC 设备对象指针
 ...
 */
mt_err_t hal_rtc_set_time(struct hal_rtc_dev* pdev, const struct hal_rtc_time* time) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 读取 RTC 当前日历时间
 * @param[in] pdev RTC 设备对象指针
 ...
 * @return 成功返回 MINI_OK, 参数非法返回 MINI_ERR_INVAL
 */
mt_err_t hal_rtc_get_time(struct hal_rtc_dev* pdev, struct hal_rtc_time* time) MINI_WARN_UNUSED_RESULT;
/**
 ...
 * @return 成功返回 MINI_OK, 参数非法返回 MINI_ERR_INVAL
 */
mt_err_t hal_rtc_set_alarm(struct hal_rtc_dev* pdev, const struct hal_rtc_time* alarm, hal_rtc_alarm_cb_t cb, void* user) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 取消闹钟 A
 * @param[in] pdev RTC 设备对象指针
 * @return 成功返回 MINI_OK, pdev 为空返回 MINI_ERR_INVAL
 */
mt_err_t hal_rtc_cancel_alarm(struct hal_rtc_dev* pdev) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 设置 RTC 唤醒定时器
 * @param[in] pdev RTC 设备对象指针
 ...
 * @return 成功返回 MINI_OK, 参数非法返回 MINI_ERR_INVAL
 */
mt_err_t hal_rtc_set_wakeup_timer(struct hal_rtc_dev* pdev, uint32_t seconds) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 取消 RTC 唤醒定时器
 * @param[in] pdev RTC 设备对象指针
 * @return 成功返回 MINI_OK, pdev 为空返回 MINI_ERR_INVAL
 */
mt_err_t hal_rtc_cancel_wakeup_timer(struct hal_rtc_dev* pdev) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 强制停止 RTC (断电保护/紧急停机用)
 * @return 成功返回 MINI_OK, 失败返回负数错误码
 */
mt_err_t hal_rtc_force_stop(void) MINI_WARN_UNUSED_RESULT;
