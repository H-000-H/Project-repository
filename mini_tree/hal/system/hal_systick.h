 ...
 * @return MINI_OK 成功; MINI_ERR_NOTSUPP 平台无 SysTick (非 Cortex-M); 负的 MINI_ERR_* 配置失败
 ...
 * TIM。
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_systick_init(uint32_t tick_hz);

/**
 * @brief 停止并关闭 SysTick
 * @return MINI_OK 成功
 */
mt_err_t MINI_WARN_UNUSED_RESULT hal_systick_deinit(void);
