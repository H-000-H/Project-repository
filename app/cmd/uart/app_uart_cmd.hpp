 ...
 */
#ifndef APP_UART_CMD_HPP
#define APP_UART_CMD_HPP
#include <cstddef>
#include <cstdint>
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------ */
    ...
    // ota.start 命令参数 (串口行命令: cmdota <len>)
    struct OtaArgs
    {
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------ */
    // 命令层: 注册 led.set / ota.start 命令, 并把 UART 收包回调挂到实例
    class Cmd
    {
    public:
/* ------------------------------------------------------------------------------------------------------------------------------------------------ */
